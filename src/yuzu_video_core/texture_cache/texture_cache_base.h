...
#include "yuzu_video_core/texture_cache/descriptor_table.h"
...
public:
    ...
    std::optional<RasterizerDownloadArea> GetFlushArea(DAddr cpu_addr, u64 size);
